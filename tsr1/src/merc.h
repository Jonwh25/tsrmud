...
typedef struct  mprog_list		MPROG_LIST;  /* MOBPROGS */
typedef struct  mprog_code		MPROG_CODE;  /* MOBPROGS */
 ...
 */
#define WRITE_STR(field, value) \
	free_string(field); \
	field = str_dup( value );
#define MAX_KEY_HASH             1024
#define MAX_STRING_LENGTH        4608
#define MAX_INPUT_LENGTH          257
#define PAGELEN                    22
 ...
 */
#define MAX_SOCIALS               257
#define MAX_SKILL                 175
#define MAX_LANGUAGE                9
#define MAX_GROUP                  30 
#define MAX_IN_GROUP              100 
#define MAX_ALIAS                  15
#define MAX_CLASS                  21
...
#define MAX_LEVEL                  161
#define LEVEL_IMMORTAL             (MAX_LEVEL - 8)
#define LEVEL_BUILD                152
...
#define ADMINISTRATOR             MAX_LEVEL
...
#define AUTOLEARN             100      
#define FORCE_LANGUAGE        100      
/*
 * Site ban structure.
 */
...
#define CON_READ_BMOTD                  14
#define CON_READ_IMOTD                  15
#define CON_READ_MOTD                   16
#define CON_GET_EMAIL			17
#define CON_AUTHORIZE_NAME              18
#define CON_AUTHORIZE_NAME1             19
#define CON_AUTHORIZE_NAME2             20 
#define CON_AUTHORIZE_NAME3             21
#define CON_AUTHORIZE_LOGOUT            22
#define CON_BEGIN_REMORT		23
#define CON_BREAK_CONNECT               24

/*
* connect states for editors
*/
...
struct class_type
{
    ...
    int         hometown;               /* Class recall Room            */
...
struct race_type
{
    ...
    long        act2;                   /* NEW act bits for the race */
    int         race_lang;		/* For languages */
...
/* 
 * ACK! I ran out of act bits! Therefore act2 was created with
 * help from whiplash. :) -Beowolf
 */

#define ACT2_CHALLENGER         (A) 
#define ACT2_CHALLENGED         (B)  
#define ACT2_MOUNTABLE          (C)  
#define ACT2_TEACHER            (D)  
...
#define AFF_CURSE               (K)
#define AFF_WATER_BREATH        (L)  /* Donated by Shelly Lahmn aka- Honey */
#define AFF_POISON              (M)
...
/*
 * Ooops...We do it Yet again...We rock...heh.  Time to make
 * the MUD even bigger.
 *      -Beowolf
 * 
 * Bits for 'ch->flag2'.
...
#define AFF_MUTE               (A)
#define AFF_POLYMORPH          (B)
#define AFF_VAMP_BITE          (C)
#define AFF_FLAMING            (D)
#define AFF_BLOODLUST          (E)
#define AFF_FEAR               (E)
#define AFF_EXHAUSTED          (F)
...
#define OBJ_VNUM_FLYINGCARPET      1200
...
#define ITEM_SADDLE                  35
#define ITEM_SHIP	             36 
#define ITEM_CARRIAGE	             37 
...
#define ROOM_VNUM_ALTAR            3199
#define ROOM_VNUM_SCHOOL           3700
#define ROOM_VNUM_BALANCE          4500
#define ROOM_VNUM_CIRCLE           4400
#define ROOM_VNUM_DEMISE           4201
#define ROOM_VNUM_HONOR            4300
#define ROOM_VNUM_MORGUE           3199
#define ROOM_VNUM_ALOSER           5911
#define ROOM_VNUM_AWINNER          5912

/* Sect Defined transfer rooms */

#define ROOM_VNUM_SECT_CHAOS	   21000 
#define ROOM_VNUM_SECT_PRIDE	   3001
#define ROOM_VNUM_SECT_BALANCE     3001
#define ROOM_VNUM_SECT_OBLIVION	   5633 
#define ROOM_VNUM_SECT_RETRIBUTION 4311 
#define ROOM_VNUM_SECT_FAITH	   3001 
#define ROOM_VNUM_SECT_STRIFE	   3001 
#define ROOM_VNUM_SECT_APOCALYPSE  3001 
...
#define ROOM_BANK               (U)
#define ROOM_ARENA              (V)
#define ROOM_CONE_OF_SILENCE    (W)
#define ROOM_UNDERGROUND        (Y)
...
#define WEAR_BELT_L	 	     20
#define WEAR_BELT_R		     21
#define MAX_WEAR                     22

/* mob guard stuff - by Froth of Dyre MUD*/
/* when the guard mob acts */
#define  MOB_GUARD_DIR_NORTH 		(A)
#define  MOB_GUARD_DIR_SOUTH 		(B)
#define  MOB_GUARD_DIR_EAST 		(C)
#define  MOB_GUARD_DIR_WEST 		(D)
#define  MOB_GUARD_DIR_UP 		(E)
#define  MOB_GUARD_DIR_DOWN 		(F)

/* what the guard mob does when it acts */
#define  GUARD_ACTION_STOP_CHAR		(A)
#define  GUARD_ACTION_ATTACK 		(B)
#define  GUARD_ACTION_TELEPORT		(C)
#define  GUARD_ACTION_CHECK_ITEM	(D)
#define  GUARD_ACTION_CHECK_CLASS	(E)
#define  GUARD_ACTION_CHECK_RACE	(F)
#define  GUARD_ACTION_CHECK_SECT	(G)
#define  GUARD_ACTION_CHECK_LEVEL	(H)
#define  GUARD_ACTION_CHECK_AGE 	(I)
#define  GUARD_ACTION_CHECK_ALIGN	(J)
...
struct mob_index_data
{
    ...
    sh_int               dam_type;
    long                 off_flags;
    sh_int	  	 guard_dir;    /* For mob guards - Froth */
    sh_int               guard_action; /* For mob guards - Froth */
    sh_int               pass_vnum;    /* item vnum that let's players pass */
    long                 imm_flags;
    long                 res_flags;
    long                 vuln_flags;
    sh_int               start_pos;
...
struct char_data
{
    ...
    CHAR_DATA *         reply;
    CHAR_DATA *         pet;
    CHAR_DATA *		mprog_target;     /* MOBPROGS */
    CHAR_DATA *         gladiator;        /* ARENA player wagered on */
    CHAR_DATA *         mind;             /* Memory code */
    MEM_DATA *          memory;
    SPEC_FUN *          spec_fun;
    ...
    int                 generation;                /* for the pager */
    time_t              logon;
    time_t		idle_start_time;      /* idle stuff */
    sh_int              timer;
    sh_int              wait;
    sh_int              newbie_msg;
    sh_int              daze;
    ...
    sh_int		guard_action;   /* For mob guards - Froth */
    sh_int		pass_vnum;      /* item vnum that let's players pass */
    sh_int		ridden;         /* NPC's or PC's mounted state */
    int                 plr_wager;      /* ARENA amount wagered */
    int                 awins;          /* ARENA number of wins */
    int                 alosses;        /* ARENA number of losses */
    sh_int              default_pos;
    int                 lagged;         /* heh. lag is cool. */
    sh_int		mprog_delay;    /* MOBPROGS */
    bool		in_ship;        /* is player in ship */
    OBJ_DATA *		ship_name;      /* name of ship */
    sh_int	        ship_fuel; 
    bool		in_wagon;       /* is player in wagon */
    OBJ_DATA *		wagon_name;     /* name of wagon */
    sh_int	        wagon_fuel; 
    long		flag2;          /* New Aff flags */
    long		flag3;          /* New Aff flags */
    long		flag4;          /* New Aff flags */
};
...
struct pc_data
{
    ...
    int                 awins;      /* ARENA number of wins */
    int                 alosses;    /* ARENA number of losses */
    sh_int		mounted;    /* pc's mounted state */
    int                 language        [ MAX_LANGUAGE ];
    int                 speaking;
    int                 learn;
    long                last;      /* Player last login */
};
...
struct obj_data
{
    ...
    sh_int timer;
    int value[5];
    CHAR_DATA *		ship_captin;
    CHAR_DATA *		wagon_driver;
};
...
extern const struct race_type race_table [MAX_RACE]; /* Envy Code for poly */
...
extern const struct flag_type guard_direction[];
extern const struct flag_type guard_action[];
...
extern sh_int gsn_exhausted;
extern sh_int gsn_sleep;
extern sh_int gsn_fly;
extern sh_int gsn_flying_carpet;
extern sh_int gsn_sanctuary;
extern sh_int gsn_untangle;

extern sh_int gsn_destroy_cursed;
extern sh_int gsn_mute;
extern sh_int gsn_test_spell;
extern sh_int gsn_polymorph_other;
extern sh_int gsn_vampiric_bite;
extern sh_int gsn_flaming;
...
extern sh_int gsn_cloak; /* UOFFMUD cloak */
...
extern  sh_int   gsn_bodak;
extern  sh_int   gsn_sithid;
 ...
 * Character macros.
 */
#define IS_NEWBIE(ch)		((!IS_NPC(ch)) && ch->level <= 5)
#define IS_ADMIN(ch)		(get_trust(ch) >= MAX_LEVEL - 1)
...
#define IS_FLAG2(ch, sn)        (IS_SET((ch)->flag2, (sn)))
#define IS_FLAG3(ch, sn)        (IS_SET((ch)->flag3, (sn)))
#define IS_FLAG4(ch, sn)        (IS_SET((ch)->flag4, (sn)))
...
extern		MPROG_CODE	  *	mprog_list;  /* MOBPROGS */
...
extern		bool			MOBtrigger;  /* MOBPROGS */
...
#define MPC	MPROG_CODE     /* MOBPROGS */
...
void    rand_to_char    args( ( CHAR_DATA *ch , char *str1,char *str2,char *str3,char *str4,char *str5 ) );
...
MPC *	get_mprog_index args( ( int vnum ) );  /* MOBPROGS */
...
char *guard_bit_name args((int guard_dir));
char *action_bit_name args((int guard_action));
...
/* mobguard.c */
bool  checkmobguard  args( ( CHAR_DATA *ch, int dir) );
