...
fprintf( fp, "Sec  %d\n",    ch->pcdata->security	);	/* OLC */
	...
	ch->pcdata->last_news,ch->pcdata->last_letter	);
    fprintf( fp, "Scro %d\n", 	ch->lines		);
    fprintf( fp, "Room %d\n",
	...
	fprintf( fp, "Incr %d\n",
 	...
 	/* Color */
        fprintf( fp, "Color %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d\n",
    	    ch->pcdata->color,
    	    ch->pcdata->color_charmed,
    	    ch->pcdata->color_dev,
    	    ch->pcdata->color_prompt,
    	    ...
    	    ch->pcdata->color_shout,
    	    ch->pcdata->color_auction,
    	    ch->pcdata->color_yell,
    	    ch->pcdata->color_gossip,
    	    ch->pcdata->color_grats,
    	    ch->pcdata->color_info,
    	    ch->pcdata->color_music,
    	    ch->pcdata->color_quote,
    	    ch->pcdata->color_immortal,
    	    ch->pcdata->color_build,
    	    ch->pcdata->color_newbie,
    	    ch->pcdata->color_admin
	);
	...
	for ( sn = 0; sn < MAX_LANGUAGE; sn++)		/* Save lang's */
        {
            fprintf( fp, "Lang        %d '%s'\n",
...
bool load_char_obj( DESCRIPTOR_DATA *d, char *name )
{
    ...
    ch->pcdata->color_charmed		= 0xe;
    ch->pcdata->color_dev		= 0x4;
    ch->pcdata->color_prompt		= 0x6;
    ch->pcdata->color_hidden		= 0xa;
    ch->pcdata->color_invis		= 0xc;
    ch->pcdata->color_ooc		= 0xb;
    ch->pcdata->color_reply		= 0xa;
    ch->pcdata->color_say		= 0x5;
    ch->pcdata->color_tell		= 0x2;
    ch->pcdata->color_wizi		= 0xc;
    ch->pcdata->color_shout		= 0x1;
    ch->pcdata->color_auction		= 0xd;
    ch->pcdata->color_yell		= 0x8;
    ch->pcdata->color_gossip		= 0x0;
    ch->pcdata->color_grats		= 0xc;
    ch->pcdata->color_info		= 0x9;
    ch->pcdata->color_music		= 0x5;
    ch->pcdata->color_quote		= 0x0;
    ch->pcdata->color_immortal		= 0x5;
    ch->pcdata->color_build		= 0xb;
    ch->pcdata->color_newbie		= 0xb;
    ch->pcdata->color_admin		= 0xb;
    ch->newbie_msg			= 5;
...
void fread_char( CHAR_DATA *ch, FILE *fp )
{
	    ...
	    KEY( "Clan",	ch->clan,	clan_lookup(fread_string(fp)));
            ...
            if ( !str_cmp( word, "Color")) 
            {
               /* log_string("Reading colors"); */
                fread_number(fp); /* color var */
               /* ch->pcdata->color 		= fread_number( fp );*/
    		ch->pcdata->color_charmed	= fread_number( fp );
    		ch->pcdata->color_dev    	= fread_number( fp );
    		ch->pcdata->color_prompt	= fread_number( fp );
    		ch->pcdata->color_hidden	= fread_number( fp );
    		ch->pcdata->color_invis		= fread_number( fp );
    		ch->pcdata->color_ooc		= fread_number( fp );
    		...
    		ch->pcdata->color_shout		= fread_number( fp );
    		ch->pcdata->color_auction	= fread_number( fp );
    		ch->pcdata->color_yell  	= fread_number( fp );
    		ch->pcdata->color_gossip	= fread_number( fp );
    		ch->pcdata->color_grats		= fread_number( fp );
    		ch->pcdata->color_info          = fread_number( fp );
    		ch->pcdata->color_music 	= fread_number( fp );
    		ch->pcdata->color_quote 	= fread_number( fp );
    		ch->pcdata->color_immortal	= fread_number( fp );
    		ch->pcdata->color_build		= fread_number( fp );
    		ch->pcdata->color_newbie        = fread_number( fp );
    		ch->pcdata->color_admin		= fread_number( fp );
		fMatch = TRUE;
		break;
	    }
	...
	case 'L':
            KEY( "Last",	ch->pcdata->last,	fread_number( fp ) );
	...
	case 'N':
		...
		ch->pcdata->last_letter 		= fread_number(fp);
		fMatch = TRUE;
		break;
	    }
	    break;
