...
/*  {   command         function        }, */
    ...
    {   "guard",        medit_guard   },  /* ROM */
    {   "action",       medit_action   },  /* ROM */
    {   "gvnum",        medit_gvnum   },  /* ROM */
...
void display_resets( CHAR_DATA *ch )
{
  ...
  "\n\r", ch );
	...
	case 'M':
	    ...
	    pMob = pMobIndex;
	    sprintf( buf, "M[%5d] %-13.13s in room      R[%5d] [%3d] [%3d] %-15.15s\n\r",
...
void do_resets( CHAR_DATA *ch, char *argument )
{
	  ...
	  || (!str_cmp( arg2, "obj" ) && is_number( arg3 )) )
	{
		...
		pReset->arg4    = is_number( arg6 ) ? atoi( arg6 ) : 1; /* Max # */
	    }
	    else
	    /*
