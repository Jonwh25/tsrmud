...
MPROG_CODE *		mprog_list;   /* MOBPROGS */
...
sh_int  		gsn_staves;
sh_int  		gsn_wands;
sh_int                  gsn_cloak; /* UOFFMUD cloak */
sh_int  		gsn_recall;
...
void	load_mobprogs	args( ( FILE *fp ) );  /* MOBPROGS */
  

void	fix_exits	args( ( void ) );
void    fix_mobprogs	args( ( void ) );    /* MOBPROGS */
...
/* MOBPROGS */  else if ( !str_cmp( word, "MOBPROGS" ) ) load_mobprogs(fpArea);
	...
	help_greeting = "Brave Adventurer, Who are you? ";
    }
...
/*  OLC-Removed
    ...
    pArea->reset_last   = NULL;
*/
garbage = fread_string(fp) ;
garbage= fread_string(fp) ;
    pArea->name         = fread_string( fp );
garbageint= fread_number(fp) ;
garbageint=fread_number(fp) ;
...
void load_old_mob( FILE *fp )
{
	...
	pMobIndex->sex			= fread_number( fp );
   	...
   	if (name[0] == '\0' || (race =  race_lookup(name)) == 0)
   	{
            ...
            /* added to initialize old mobs - Froth */
  	    pMobIndex->guard_dir			= 0 ;
	    pMobIndex->guard_action	         	= 0 ;
	    pMobIndex->pass_vnum 			= 0 ;
...
/*******************************************************************************
The following code was B-A-D. It worked yet it was fucking some major shit up.
At least now I know why :)  The above code is the fix sent to me from Stryfe.
What a guy :)
 
Strife Daemonkin
The Providence of Coranthia:  mserv.wizvax.net 9201
Email:                        strife@mserv.wizvax.net
...
void load_rooms( FILE *fp )
{
	...
	for ( ; ; )
	{
	   ...
	   else if ( letter == 'C') /* clan */
	   {
		...
		case 4: pexit->rs_flags  = EX_ISDOOR | EX_NOPASS | EX_PICKPROOF;  break;
	    }
...
/******************************************************************************
Yet another Bug fix discovered by our man Strife. Here is what he had to say.

Since the majority of the stock Merc areas have arg2 of RESET_DATA as
0 it screws things up royally.  Hope this all helps.  I'll be sure to
send any additional bugfixs/enhancements your way as they develop.
-Strife Daemonkin
-The Providence of Coranthia:  mserv.wizvax.net 9201
-Email:                        strife@mserv.wizvax.net
...
CHAR_DATA *create_mobile( MOB_INDEX_DATA *pMobIndex )
{
    ...
    mob->prompt		= NULL;
    mob->mprog_target   = NULL;     /* MOBPROGS */
	...
	mob->off_flags		= pMobIndex->off_flags;
                 /* MOB GUARDAINS */	
	mob->guard_dir		= pMobIndex->guard_dir;
	mob->guard_action	= pMobIndex->guard_action;
	mob->pass_vnum		= pMobIndex->pass_vnum;
                /* END MOB GUARDS */	
...
void clone_mobile(CHAR_DATA *parent, CHAR_DATA *clone)
{
    ...
    clone->guard_dir	= parent->guard_dir;
    clone->guard_action = parent->guard_action;
    clone->pass_vnum	= parent->pass_vnum;
