...
DECLARE_SPEC_FUN(	spec_sect_guard 	);
...
const   struct  spec_type    spec_table[] =
{
    ...
    {	"spec_sect_guard",		spec_sect_guard		},
    {	NULL,				NULL			}
};
*/
...
const	struct	spec_type	spec_table	[ ] =
{
     ...
     */
    { "spec_breath_any",	spec_breath_any		},
    { "spec_nasty",             spec_nasty              }, /*Nikki*/
    { "spec_troll_member",      spec_troll_member       }, /*Nikki*/
    { "spec_ogre_member",       spec_ogre_member        }, /*Nikki*/
    { "spec_patrolman",         spec_patrolman          }, /*Nikki*/    
    { "spec_questmaster",       spec_questmaster        }, /*Nikki*/
    { "spec_breath_acid",	spec_breath_acid	},
    { "spec_breath_fire",	spec_breath_fire	},
    { "spec_breath_frost",	spec_breath_frost	},
    { "spec_breath_gas",	spec_breath_gas		},
...
char *spec_name( SPEC_FUN *function)
{
    ...
    for (i = 0; spec_table[i].spec_fun != NULL; i++)
    {
	if (function == spec_table[i].spec_fun)
	    return spec_table[i].spec_name;
    }
...
/*
 * 	Idea from Aesir (asgard.ncsa.uiuc.edu)	
 *	Originally coded by Thor@Aesir
 * 	Coded for Rom2.4 by Belar   rls1@Ra.MsState.Edu
 */

bool spec_sect_guard( CHAR_DATA *ch )
{
    char *message;
    CHAR_DATA *victim;
    CHAR_DATA *v_next;
	...
	v_next = victim->next_in_room;
        ...
        {
	    default:  message = NULL; 	break;
	    case 0: message = "$n says 'Day in, day out, This is all I am about.'";
		    break;
	    case 1: message = "$n looks at you and cackles wildly!";
	    	    break;
	    case 2: message = "$n asks 'Do they call you Unforgiven?'";
		    break;
	    case 3: message = "$n says 'Run quickly now...you have your black stick right?'";
		    break;
	    case 4: message = "$n says 'I said damn, what a MUD!'";
		    break;	
	    case 5: message = "$n says 'How did all those fish get up there?'";
		    break;
	    case 6: message = "$n utters the words 'see ya later fool'";
		    break;
	    case 7: message = "$n says 'This transport brought to you by the letter Z and the number 9'";
		    break;
	    case 8: message = "$n says 'Oh boy, cosmic forces reveal a spontaneous influx of items!'";
		    break;
	    case 9: message = "$n says 'If the Mayor is in a room alone,'\r
$n says 'Does he say 'Good morning citizens?'";
		    break;
	    case 10: message = "$n says 'I wasn't expecting the Spanish Inquisition'";
		    break;
	    case 11: message = "$n says 'Quick! Reverse the polarity of the neutron flow!'";
		    break;
	    case 12: message = "$n says 'Shh... I'm beta testing. I need complete silence!'";
		    break;
	    case 13: message = "$n says 'I'm the real implementor, you know.'";
		    break;
	    case 14: message = "$n says 'ACK! Someone purge me quick!'";
		    break;
        }
        if (message != NULL)
    	    act(message,ch,NULL,victim,TO_ALL);
        ...
        char_to_room(victim, 
		       (get_room_index(clan_table[victim->clan].clan_area)));
	do_look( victim, "auto" );
        return TRUE;
    }
    return FALSE;
