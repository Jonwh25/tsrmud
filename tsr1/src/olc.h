 ...
 * OLC Constants
 */
#define MIN_MOB 1               /* Default minimum number for resetting mobs */
#define MIN_OBJ 1               /* Default minimum number for resetting objs */
...
DECLARE_OLC_FUN(medit_act2);    /* NEW act bits */
...
DECLARE_OLC_FUN(medit_guard);     /* ROM */
DECLARE_OLC_FUN(medit_action);     /* ROM */
DECLARE_OLC_FUN(medit_gvnum);     /* ROM */
