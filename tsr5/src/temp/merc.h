...
/* 
 * default board is board #0 in the boards. It should be 
 * readable by everyone! Enforce a MAX_LENGTH of 80 on text
 * lines, reject longer lines. This only applies in the body
 * of the note. -Erwin
 */
...
#define CON_AUTHORIZE_NAME             19
#define CON_AUTHORIZE_NAME1	       20
#define CON_AUTHORIZE_NAME2	       21
#define CON_AUTHORIZE_NAME3	       22
#define CON_AUTHORIZE_LOGOUT           23
#define CON_CHATTING                   24
#define CON_NOTE_TO                    25
#define CON_NOTE_SUBJECT               26
#define CON_NOTE_EXPIRE                27
#define CON_NOTE_TEXT                  28
#define CON_NOTE_FINISH                29
#define CON_COPYOVER_RECOVER           30
...
#define ACT_BOUNTY		BV22	/* Bounty Stuff -Beo      */
...
#define ITEM_HIDDEN               65536
#define ITEM_LOCKER              131072
...
#define ROOM_VNUM_DON_1		   25087
#define ROOM_VNUM_DON_2		   25087
#define ROOM_VNUM_DON_3		   25087
#define ROOM_VNUM_DON_4		   25087
...
#define	LOCKER_VNUM		2207
#define	LOCKER_ROOM		25000	//Set this to your temple pit or whatever
 ...
 * Room flags take II
 * Used in #ROOMS.
 * Good god man! - Beowolf 3/13/01
 */
#define         ROOM_HOME    A
#define       	ROOM_RENTAL  B
#define		ROOM_RENTED  C
 ...
 * Added on 3-9-01
 */
#define PLR2_SOUND		BV01
#define PLR2_TENNANT		BV02
#define PLR2_CODING		BV03
...
#define PLR_NO_GOSSIP		 131072		/* Obsolete       */
#endif
...
struct mob_index_data {
    ...
    int level;
    int act;
    int act2;			/* Beowolf 3-9-01 New Act2 */
    long affected_by;
    long affected_by2;
    long imm_flags;		/* XOR */
    long res_flags;
...
/* The gsn's below are new from 3/16/01 and on */
...
extern int qmax;
extern int port;
extern int control;		/* for Copyover */
extern char *daPrompt;		/* SSM */
extern RECENT_DATA *recent_first;	/* Recent Code */
extern RECENT_DATA *recent_x;	/* Recent Code */
extern BOARD_DATA boards[MAX_BOARD]; /* Declare */


/* descriptor recycling for Copyover */
...
DECLARE_SPELL_FUN(spell_create_bard);
...
#define HELP_FILE       "help.txt"	/* Newbie help file               */
#define BOUNTY_FILE     "bounty.txt"	/* Bounty Stuff                 */
#define COPYOVER_FILE   "copyover.data" /* Copyover       */
#define EXE_FILE	"../src/eos"    /* COPYOVER       */
#define NOTE_DIR 	"../boards/"    /* Erwin's Boards */
#define BADWORDS_FILE   "bad.words"     /* For bad words  */
...
/* hunt_cost.c */
extern float spell_cost args((CHAR_DATA* ch, int sn));
...
OBJ_DATA *get_obj_locker_room args((CHAR_DATA * ch, int vnum));
...
void    send_to_al      args((int clr, int level, char *text)); /* for above level*/
...
void    logf            args((char *fmt,...));	/*Copyover STuff */
void    printf_to_char  args((CHAR_DATA * ch, char *fmt,...));
void    addbadname      args( (CHAR_DATA * ch, char *argument) );
...
int recent_create args((int size));
int recent_add args((CHAR_DATA * ch));
...
char *act2_bit_name args((int act2));	/* Act2 - Beo */
