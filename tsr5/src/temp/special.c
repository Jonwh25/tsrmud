...
bool spec_cast_adept(CHAR_DATA * ch)
{
    ...
    switch (number_bits(3)) {
    case 0:
	act("$n utters the word 'rodalaht'.", ch, NULL, NULL, TO_ROOM);
	spell_armor(skill_lookup("armor"), ch->level, ch, victim);
	return TRUE;

    case 1:
	act("$n utters the word 'igna'.", ch, NULL, NULL, TO_ROOM);
	spell_bless(skill_lookup("bless"), ch->level, ch, victim);
	return TRUE;

    case 2:
	act("$n utters the word 'naeralkced'.", ch, NULL, NULL, TO_ROOM);
	spell_cure_blindness(skill_lookup("cure blindness"),
			     ch->level, ch, victim);
	return TRUE;

    case 3:
	act("$n utters the word 'frehs'.", ch, NULL, NULL, TO_ROOM);
	spell_cure_light(skill_lookup("cure light"),
			 ch->level, ch, victim);
	return TRUE;

    case 4:
	act("$n utters the words 'ralker'.", ch, NULL, NULL, TO_ROOM);
	spell_cure_poison(skill_lookup("cure poison"),
			  ch->level, ch, victim);
	return TRUE;

    case 5:
	act("$n utters the words 'irehx'.", ch, NULL, NULL, TO_ROOM);
...
bool spec_cast_healer(CHAR_DATA * ch)
{
    ...
    case 4:
	act("$n utters the words 'obasi'.", ch, NULL, NULL, TO_ROOM);
	spell_cure_poison(skill_lookup("cure poison"),
			  ch->level, ch, victim);
	return TRUE;
    ...
    case 6:
	act("$n utters the words 'ecnanep'.", ch, NULL, NULL, TO_ROOM);
...
bool spec_janitor(CHAR_DATA * ch)
{
	...
	if (!IS_SET(trash->wear_flags, ITEM_TAKE))
	    continue;
	act("$n picks up some unsightly garbage.", ch, NULL, NULL, TO_ROOM);
	act("You pick up $p.", ch, trash, NULL, TO_CHAR);
	obj_from_room(trash);
...
bool spec_mayor(CHAR_DATA * ch)
{
    ...
    case 'e':
	act("$n says 'I hereby declare the city of Bethaven open!'",
	    ch, NULL, NULL, TO_ROOM);
	break;

    case 'E':
	act("$n says 'I hereby declare the city of Bethaven closed!'",
	    ch, NULL, NULL, TO_ROOM);
	break;
