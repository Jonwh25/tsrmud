...
{
    {"CLANS", "Moksha Keirkan Isabo", GUILD_NORMAL},
    {"1045", "Decklarean Angi Thalador", GUILD_NORMAL},
    {"CREATION", "Sherf", GUILD_NORMAL},
    {"", "", 0, 0}
};
 ...
 */
	...
	NULL, 20, 12,
	"&gacid blast", "!Acid Blast!", "", FALSE, SLOT(0)
    },
 ...
 */
	...
	NULL, 15, 12,
	"burning hands", "!Burning Hands!", "", FALSE, SLOT(0)
    },
	...
	NULL, 15, 12,
	"lightning bolt", "!Call Lightning!", "", FALSE, SLOT(0)
    },
	...
	NULL, 15, 12,
	"spell", "!Cause Light!", "", FALSE, SLOT(0)
    },
	...
	NULL, 17, 12,
	"spell", "!Cause Serious!", "", FALSE, SLOT(0)
    },
	...
	{L_APP, 12, L_APP, L_APP, L_APP, 26, L_APP, 37, L_APP, L_APP,
	 L_APP, L_APP, L_APP, L_APP, L_APP, L_APP},
	spell_create_bard, TAR_IGNORE, POS_STANDING,
	NULL, 5, 12,
	"", "!Create bard!", "", FALSE, SLOT(0)
    },
	...
	NULL, 15, 12,
	"dispel evil", "!Dispel Evil!", "", FALSE, SLOT(0)
    },
	...
	NULL, 15, 12,
	"earthquake", "!Earthquake!", "", FALSE, SLOT(0)
    },
	...
	NULL, 35, 12,
	"energy drain", "!Energy Drain!", "", FALSE, SLOT(0)
    },
	...
	NULL, 15, 12,
	"fireball", "!Fireball!", "", FALSE, SLOT(0)
    },
	...
	NULL, 20, 12,
	"flamestrike", "!Flamestrike!", "", FALSE, SLOT(0)
    },
   ...
   {L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP,
	...
	NULL, 25, 8,
	"icy blast", "!ICESTORM!", "", FALSE, SLOT(0)
    },
	...
	"flames", "The flames have been extinguished.",
   ...
   {L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP,
	...
	NULL, 15, 12,
	"lightning bolt", "!Lightning Bolt!", "", FALSE, SLOT(0)
    },
	...
	NULL, 15, 12,
	"magic missile", "!Magic Missile!", "", FALSE, SLOT(0)
    },
 ...
 */
	...
	NULL, 50, 12,
	"blast of acid", "!Acid Breath!", "", FALSE, SLOT(0)
    },
	...
	NULL, 50, 12,
	"blast of flame", "!Fire Breath!", "", FALSE, SLOT(0)
    },
	...
	NULL, 50, 12,
	"blast of frost", "!Frost Breath!", "", FALSE, SLOT(0)
    },
	...
	NULL, 50, 12,
	"blast of gas", "!Gas Breath!", "", FALSE, SLOT(0)
    },
	...
	NULL, 50, 12,
	"blast of lightning", "!Lightning Breath!", "", FALSE, SLOT(0)
    },
/*
 ...
 */
   ...
   {L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP,
	...
	NULL, 15, 12,
	"tongue of flame", "!Control Flames!", "", FALSE, SLOT(0)
    },
	...
	NULL, 200, 18,
	"field of death", "!Death Field!", "", FALSE, SLOT(0)
    },
	...
	NULL, 35, 24,
	"detonation", "!Detonate!", "", FALSE, SLOT(0)
    },
	...
	NULL, 10, 12,
	"mindpower", "!Inflict Pain!", "", FALSE, SLOT(0)
    },
	...
	NULL, 8, 12,
	"mind thrust", "!Mind Thrust!", "", FALSE, SLOT(0)
    },
	...
	NULL, 18, 12,
	"projected force", "!Project Force!", "", FALSE, SLOT(0)
    },
	...
	NULL, 25, 12,
	"psionic blast", "!Psionic Blast!", "", FALSE, SLOT(0)
    },
	...
	NULL, 15, 18,
	"psychic crush", "!Psychic Crush!", "", FALSE, SLOT(0)
    },
 ...
 */
   ...
   {L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP,
	...
	spell_null, TAR_CHAR_OFFENSIVE, POS_FIGHTING,
	&gsn_drain_life, 0, 12,
	"life drain", "!Drain Life!", "", FALSE, SLOT(0)
    },
   ...
   {L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP,
	...
	spell_null, TAR_CHAR_OFFENSIVE, POS_FIGHTING,
	&gsn_turn_evil, 0, 12,
	"divine power", "!Turn Evil!", "", FALSE, SLOT(0)
    },
   ...
   {L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP,
	...
	NULL, 50, 12,
	"holy flames", "!Holy Fires!", "", FALSE, SLOT(0)
    },
...
/* 250 */
   ...
   {L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP,
	...
	NULL, 50, 22,
	"electrical blast", "!CHAIN LIGHTNING!", "", FALSE, SLOT(0)
    },
	...
	NULL, 150, 25,
	"mental shockwave", "!PSY-QUAKE!", "", FALSE, SLOT(0)
    },
...
/* Necromancer spells by Hannibal. */
   ...
   {L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP,
	...
	NULL, 15, 12,
	"stench of decay", "!Stench of Decay!", "", FALSE, SLOT(0)
    },
/* Werewolf starts here -- Hannibal */
   ...
   {L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP,
	...
	spell_null, TAR_CHAR_SELF, POS_STANDING,
	&gsn_flamehand, 0, 0,
	"", "The flames on your hands flicker and vanish.",
	"The flames on $n's hands flicker and vanish.", FALSE, SLOT(108)
    },
    {
	"frosthand",
   {L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP,
	...
	spell_null, TAR_CHAR_SELF, POS_STANDING,
	&gsn_frosthand, 0, 0,
	"", "The frost and ice melt from your hands.",
	"The frost and ice melt from $n's hands.", FALSE, SLOT(109)
    },
    {
	"chaoshand",
   {L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP,
	...
	spell_null, TAR_CHAR_SELF, POS_STANDING,
	&gsn_chaoshand, 0, 0,
	"", "Your hands stop flickering, and order overtakes the chaos.",
	"$n's hands stop flickering, and order overtakes the chaos.",
	FALSE, SLOT(110)
    },
    {
	"bladepalm",
   ...
   {L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP,
	...
	spell_null, TAR_IGNORE, POS_FIGHTING,
	&gsn_globedark, 50, 0,
	"You raise your hand and the globe dissipates.",
	"You are no longer able to sustain your globe in :",
   ...
   {L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP,
	...
	spell_null, TAR_IGNORE, POS_FIGHTING,
	&gsn_spit, 0, 0,
	"&gacidic spit", "The corosive spit finally evaporates.",
	...
	"You are no longer able to sustain your ward of safety in :",
	...
	"You are no longer able to sustain your ward of healing in :",
   ...
   {L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP,
	...
	NULL, 55, 22,
	"roaring flames", "!FIRWALL!", "", FALSE, SLOT(0)
    },
