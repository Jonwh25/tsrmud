...
bool		    wizlock = TRUE;	/* Game is wizlocked		*/
...
void nanny( DESCRIPTOR_DATA *d, char *argument )
{
   ...
   else
   {
       ...
       if ( wizlock )
       {
       write_to_buffer( d, "ATTENTION: OUR MUD HAS MOVED TO A BETTER SERVER !!\n\r",0);
       write_to_buffer( d, "Our new address is: bb12.betterbox.net port 9000.\n\r",0);
       write_to_buffer( d, "\n\r We all hope to see you there.\n\r",0);
       write_to_buffer( d, "Akasha, Isaac & Hunter.\n\r",0);
       close_socket( d );
       return;
       }
