...
struct	cmd_type	cmd_table	[ ] =
{
    ...
    { "cls",	        do_cls,	        POS_STANDING,	 0,  LOG_NORMAL },
    ...
    { "playsong",	do_playsong,	POS_DEAD,	 0,  LOG_NORMAL },
    { "mplay",	        do_mplay,	POS_DEAD,	 0,  LOG_NORMAL },
    ...
    { "sinfo",         do_sinfo,        POS_DEAD,        0,  LOG_NORMAL },
...
/*    { "qjoin",		do_questflag,   POS_DEAD, 0,LOG_NORMAL },*/
    ...
    { "gossip",		do_gossip,	POS_SLEEPING,	 0,  LOG_NORMAL	},
    { ".",		do_gossip,	POS_SLEEPING,	 0,  LOG_NORMAL	},
    { "grat",		do_grat,	POS_SLEEPING,	 0,  LOG_NORMAL	},
    ...
    { "devotion",       do_devotion,    POS_DEAD,        0,  LOG_NORMAL },
    { "sects",          do_sects,       POS_DEAD,        0,  LOG_NORMAL },
    ...
    { "conference",     do_conference,  POS_DEAD,    L_ASP,  LOG_ALWAYS },
    { "info",		do_info,	POS_DEAD,    L_DIR,  LOG_ALWAYS },
    { "aclear",         do_clear,       POS_DEAD,        0,  LOG_NORMAL },
    ...
    { "admin",          do_admin,       POS_DEAD,  L_IMP,  LOG_NORMAL },
    { "advance",        do_advance,     POS_DEAD,  L_IMP,  LOG_ALWAYS },
    { "allow",          do_allow,       POS_DEAD,  L_IMP,  LOG_ALWAYS },
    { "astat",          do_astat,       POS_DEAD,  L_ASP,  LOG_NORMAL },
    { "astrip",         do_astrip,      POS_DEAD,  L_JUN,  LOG_NORMAL },
    { "at",             do_at,          POS_DEAD,  L_ASP,  LOG_NORMAL },
    /*{ "authorize",      do_authorize,   POS_DEAD,  L_GOD,  LOG_ALWAYS },*/
    { "bamfmes",        do_bamf,        POS_DEAD,  L_BLD,  LOG_NORMAL },
    { "ban",            do_ban,         POS_DEAD,  L_IMP,  LOG_ALWAYS },
    { "bugs",           do_bugs,        POS_DEAD,  L_CRE,  LOG_ALWAYS },
    { "bodybag",        do_bodybag,     POS_DEAD,  L_CRE,  LOG_ALWAYS },
    { "clandesc",       do_clandesc,    POS_DEAD,  L_GOD,  LOG_NORMAL },
    { "cloak",          do_cloak,       POS_DEAD,  L_GOD,  LOG_NORMAL },
    { "clone",		do_clone,       POS_DEAD,  L_DEM,  LOG_NORMAL },
    { "countcommands",  do_countcommands,POS_DEAD, L_IMP,  LOG_NORMAL },
    { "cset",           do_cset,        POS_DEAD,  L_GOD,  LOG_BUILD  },
    ...
    { "disconnect",     do_disconnect,  POS_DEAD,  L_CRE,  LOG_ALWAYS },
    { "echo",           do_echo,        POS_DEAD,  L_JUN,  LOG_ALWAYS },
    { "empower",	do_empower,     POS_DEAD,  L_IMP,  LOG_ALWAYS },
    { "force",          do_force,       POS_DEAD,  L_CRE,  LOG_ALWAYS },
    { "freeze",         do_freeze,      POS_DEAD,  L_CRE,  LOG_ALWAYS },
    { "goto",           do_goto,        POS_DEAD,  L_BLD,  LOG_NORMAL },
    { "hero",           do_hero,        POS_DEAD,    100,  LOG_NORMAL },
    { "hlist",          do_hlist,       POS_DEAD,  L_ASP,  LOG_NORMAL },
    { "holylight",      do_holylight,   POS_DEAD,  L_BLD,  LOG_NORMAL },
    { "ideas",          do_ideas,       POS_DEAD,  L_CRE,  LOG_ALWAYS },
    { "immtalk",        do_immtalk,     POS_DEAD,  L_BLD,  LOG_NORMAL },
    { "log",            do_log,         POS_DEAD,  L_SEN,  LOG_ALWAYS },
    { "memory",         do_memory,      POS_DEAD,  L_CON,  LOG_NORMAL },
    { "mfind",          do_mfind,       POS_DEAD,  L_ASP,  LOG_NORMAL },
    { "mlevel",         do_mlevel,      POS_DEAD,  L_CRE,  LOG_BUILD  },
    { "mload",          do_mload,       POS_DEAD,  L_CRE,  LOG_BUILD  },
    { "mpstat",         do_mpstat,      POS_DEAD,  L_MBL,  LOG_NORMAL },
    { "mpcommands",     do_mpcommands,  POS_DEAD,  L_MBL,  LOG_NORMAL },
    { "mset",           do_mset,        POS_DEAD,  L_SEN,  LOG_BUILD  },
    { "mstat",          do_mstat,       POS_DEAD,  L_ASP,  LOG_NORMAL },
    ...
    { "noemote",        do_noemote,     POS_DEAD,  L_CRE,  LOG_NORMAL },
    { "notell",         do_notell,      POS_DEAD,  L_CRE,  LOG_NORMAL },
    { "nukerep",	do_nukerep,	POS_DEAD,  L_DEM,  LOG_NORMAL },
    { "numlock",        do_numlock,     POS_DEAD,  L_DEM,  LOG_ALWAYS },
    { "ofind",          do_ofind,       POS_DEAD,  L_JUN,  LOG_NORMAL },
    { "oload",          do_oload,       POS_DEAD,  L_JUN,  LOG_BUILD  },
    { "opstat",		do_opstat,	POS_DEAD,  L_ASP,  LOG_NORMAL },
    ...
    { "plist",	        do_playerlist,  POS_DEAD,  L_ASP,  LOG_NORMAL },
    ...
    { "racelist",	do_racelist,	POS_DEAD,  L_ASP,  LOG_NORMAL },
    { "rank",	        do_rank,	POS_DEAD,  L_ASP,  LOG_NORMAL },
    ...
    { "sockets",        do_sockets,     POS_DEAD,  L_CRE,  LOG_NORMAL },
     ...
     * OLC 1.1b
     */
    { "aedit",		do_aedit,	POS_DEAD, L_BLD,  LOG_BUILD  },
    { "cedit",          do_cedit,       POS_DEAD, L_GOD,  LOG_BUILD  },
    { "hedit",          do_hedit,       POS_DEAD, L_GOD,  LOG_BUILD  },
    { "redit",		do_redit,	POS_DEAD, L_BLD,  LOG_BUILD  },
    { "oedit",		do_oedit,	POS_DEAD, L_BLD,  LOG_BUILD  },
    { "medit",		do_medit,	POS_DEAD, L_BLD,  LOG_BUILD  },
    ...
    { "mreset",		do_mreset,	POS_DEAD, L_BLD,  LOG_NORMAL },

    { "sedit",		do_sedit,	POS_DEAD, L_ASP,  LOG_BUILD  },
    { "rename_obj",	do_rename_obj,	POS_DEAD, L_ASP,  LOG_ALWAYS },
    { "race_edit",	do_race_edit,	POS_DEAD, L_IMP,  LOG_ALWAYS },
    { "nedit",		do_nedit,	POS_DEAD, L_GOD,  LOG_BUILD  }, 
    /*
     * End of list.
     */
...
void do_countcommands( CHAR_DATA *ch, char *argument )
{
  ...
  for ( scnt = 0; skill_table[scnt].name[0] != '\0'; scnt++ )
  {
    for ( iclass = 0; iclass < MAX_CLASS; iclass++ )
    {
       if ( skill_table[scnt].skill_level[iclass] < L_ASP )
       {
...
void do_pkill( CHAR_DATA *ch, char *argument )
{
    ...
    if (!str_cmp( argument, "yes" ) )
    {
      ...
      act( AT_RED, 
       "$n has made a lifelong decision, to join forces with Pkillers throughout the realms!",
