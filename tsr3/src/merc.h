...
#define L_CRE                     ( L_APP - 1 )
#define L_ASP                     ( L_CRE - 1 )
#define L_MBL                     ( L_ASP - 1 )
#define L_BLD                     ( L_MBL - 1 )
#define L_CHAMP5		  ( L_BLD - 1 )
...
#define CON_NAME_CONTRACT	       19
#define CON_RULE_ACCEPT  	       20
#define CON_CHECK_SOUND  	       21
...
/* Grats ! */
#define CHANNEL_GRAT           33554432
#define CHANNEL_WAR            67108864
...
#define IS_SOUND( ch )		( IS_SET( ( ch )->act, PLR_SOUND ) )
...
DECLARE_SPELL_FUN(	spell_resonate  	);
...
void    sound_to_all    args( ( const char *text ) );
...
char *	immextra_bit_name	args( ( int extra_flags ) );
