...
DO_FUN *skill_function( char *name )
{
	...
	if ( !str_cmp( name, "do_avspeak" ))		return do_avspeak;
	...
	if ( !str_cmp( name, "do_count" ))	        return do_count;
	...
	if ( !str_cmp( name, "do_glance" ))		return do_glance;
        if ( !str_cmp( name, "do_godbonk" ))            return do_godbonk;
        if ( !str_cmp( name, "do_gold" ))               return do_gold;
        if ( !str_cmp( name, "do_gossip" ))             return do_gossip;
	if ( !str_cmp( name, "do_goto" ))		return do_goto;
	if ( !str_cmp( name, "do_gouge" ))		return do_gouge;
	if ( !str_cmp( name, "do_grats" ))		return do_grats;
	...
	if ( !str_cmp( name, "do_mlevel" ))		return do_mlevel;
...
/*	if ( !str_cmp( name, "do_opentourney" ))	return do_opentourney; */
	...
	if ( !str_cmp( name, "do_pecho" ))		return do_pecho;
	if ( !str_cmp( name, "do_pick" ))		return do_pick;
	if ( !str_cmp( name, "do_pkill" ))		return do_pkill;
	...
	if ( !str_cmp( name, "do_psound" ))		return do_psound;
	...
	break;
    case 's':
	if ( !str_cmp( name, "do_schat" ))		return do_schat;
	if ( !str_cmp( name, "do_snote" ))		return do_snote;
	if ( !str_cmp( name, "do_sidea" ))		return do_sidea;
	if ( !str_cmp( name, "do_spenalty" ))		return do_spenalty;
	if ( !str_cmp( name, "do_snews" ))		return do_snews;
	if ( !str_cmp( name, "do_schanges" ))		return do_schanges;
	...
	if ( !str_cmp( name, "do_secho" ))		return do_secho;
	...
	if ( !str_cmp( name, "do_wiznet" ))		return do_wiznet;
	break;
    case 'y':
...
char *skill_name( DO_FUN *skill )
{
    ...
    if ( skill == do_avspeak )		return "do_avspeak";
    ...
    if ( skill == do_count )     	return "do_count";
    ...
    if ( skill == do_godbonk )          return "do_godbonk";
    if ( skill == do_gold )             return "do_gold";
    if ( skill == do_gossip )           return "do_gossip";
    if ( skill == do_goto )		return "do_goto";
    if ( skill == do_gouge )		return "do_gouge";
    if ( skill == do_grats )		return "do_grats";
    ...
    if ( skill == do_mlevel )		return "do_mlevel";
...
/*  if ( skill == do_opentourney )	return "do_opentourney"; */
    ...
    if ( skill == do_pecho )		return "do_pecho";
    if ( skill == do_pick )		return "do_pick";
    if ( skill == do_pkill )		return "do_pkill";
    ...
    if ( skill == do_psound )		return "do_psound";
    ...
    if ( skill == do_schat )    	return "do_schat";
    if ( skill == do_snote )	        return "do_snote";
    if ( skill == do_sidea )	        return "do_sidea";
    if ( skill == do_spenalty )	        return "do_spenalty";
    if ( skill == do_snews )	        return "do_snews";
    if ( skill == do_schanges )	        return "do_schanges";
    ...
    if ( skill == do_secho )		return "do_secho";
    ...
    if ( skill == do_wiznet )		return "do_wiznet";
